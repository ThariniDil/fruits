        ...
        <div id="container" class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <h2 class="text-center">Insert Sales data here</h2>
                    <br><br>
                    <form method="post" action="<?php echo site_url('Sales/submit_data'); ?>" name="data_register">
                        <label for="Name">Enter Sales Person Name</label>
                        <input type="text" class="form-control" name="sname" required >
                        <br>
                        <label for="tel">Enter Sales Person Tel</label>
                        <input type="text" class="form-control" name="stel" required>
                        <br>
...
//$sql = "SELECT * FROM passenger";
                           echo site_url('Sales/retrieve_data');
